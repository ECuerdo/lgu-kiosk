            ...
            {resident ? (
              <div className="relative" ref={profileMenuRef}>
                <button
                  ...
                  className="flex items-center gap-4 text-left p-2 rounded-2xl hover:bg-slate-100/60 dark:hover:bg-white/5 transition-all active:scale-[0.98]"
                ...
                >
                  <div className="text-right hidden sm:block">
                    ...
                    <div className="flex items-center gap-2 justify-end">
                      ...
                      <Badge variant="outline" className="text-theme-primary border-theme-secondary uppercase font-black text-[9px]">
                        {TRANSLATIONS[lang].portal}
                      </Badge>
                    </div>
                  </div>
                  <div className="w-16 h-16 rounded-[2rem] bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/10 flex items-center justify-center overflow-hidden shadow-inner relative">
                    {residentPhotoUrl ? (
                ...
                {profileMenuOpen && (
                  <div className="absolute right-0 mt-3 w-80 origin-top-right rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0c1120] p-2.5 shadow-2xl ring-1 ring-black/5 dark:shadow-black/70 z-50 animate-in fade-in zoom-in-95 duration-150 text-left">
                    {/* Header info */}
                    ...
                    <div className="space-y-1.5">
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-between p-3 rounded-2xl hover:bg-emerald-50 dark:hover:bg-emerald-950/40 text-left transition-colors group cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-between p-3 rounded-2xl hover:bg-slate-100 dark:hover:bg-slate-800/60 text-left transition-colors group cursor-pointer"
                      >
                        <div className="flex items-center gap-3.5">
                      ...
                      <div className="pt-1.5 border-t border-slate-100 dark:border-slate-800/80 mt-1.5">
                        <button
                          ...
                          className="w-full flex items-center gap-3.5 p-3 rounded-2xl hover:bg-red-50 dark:hover:bg-red-950/30 text-left transition-colors text-red-600 dark:text-red-400 group cursor-pointer"
                        >
