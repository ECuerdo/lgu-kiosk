            ...
            try {
                ...
                if (r) {
                    ...
                    if (txData) {
                        ...
                        setFormData(prev => {
                            ...
                            const residentName = [r.firstName, r.middleName, r.lastName].filter(Boolean).join(" ") + (r.suffix ? " " + r.suffix : "");
                            const isMale = r.gender?.toUpperCase() === "MALE";
                            ...
                            return {
                                ...
                                husbandFullName: addData.husbandFullName || (isSelf && isMale ? residentName.toUpperCase() : ""),
                                wifeFullName: addData.wifeFullName || (isSelf && !isMale ? residentName.toUpperCase() : ""),
                        ...
                        setFormData(prev => {
                            ...
                            return {
                                ...
                                husbandFullName: isSelf && isMale ? residentName.toUpperCase() : (prev.husbandFullName || ""),
                                wifeFullName: isSelf && !isMale ? residentName.toUpperCase() : (prev.wifeFullName || "")
                            };
                        });
                    }
                }
                ...
                if (typesResult.success && typesResult.data) {
                    ...
                    if (psaType) {
                        ...
                        await logDebugMessage("Client: LCR_MARRIAGE_CERTIFIED_TRUE_COPY_APPOINTMENT type NOT found in dbTypes list");
                    }
                } else {
        ...
        setFormData(prev => {
            ...
            if (name === "relationship") {
                if (value === "SELF" && resident) {
                    const residentName = [resident.firstName, resident.middleName, resident.lastName].filter(Boolean).join(" ") + (resident.suffix ? " " + resident.suffix : "");
                    const isMale = resident.gender?.toUpperCase() === "MALE";

                    next.husbandFullName = isMale ? residentName.toUpperCase() : "";
                    next.wifeFullName = !isMale ? residentName.toUpperCase() : "";
        ...
        if (name === "relationship" && value === "SELF") {
            const promise = (async () => {
                ...
                if (resResult.success && resResult.data) {
                    ...
                    const residentName = [currentResident.firstName, currentResident.middleName, currentResident.lastName].filter(Boolean).join(" ") + (currentResident.suffix ? " " + currentResident.suffix : "");
                    const isMale = currentResident.gender?.toUpperCase() === "MALE";

                    setFormData(prev => ({
                        ...prev,
                        husbandFullName: isMale ? residentName.toUpperCase() : prev.husbandFullName,
                        wifeFullName: !isMale ? residentName.toUpperCase() : prev.wifeFullName
                    }));
                }

                // Check Form 3A as well
            ...
            toast.promise(promise, {
                loading: "Fetching resident profile & checking Form 3A status...",
                success: "Profile data and Form 3A status loaded.",
                error: "Failed to load profile or Form 3A status."
            });
        }
    };
    ...
    return (
        <>
            <style dangerouslySetInnerHTML={{
                ...
                .bg-rose-500\\/20, [class*="bg-rose-500/20"] {
                                    ...
                                    <div className="space-y-6">
                                        <div className="space-y-2">
                                            ...
                                            {(formData.relationship === "OTHER" || formData.relationship === "RELATIVE") ? (
                                                ...
                                                >
                                                    <SelectTrigger className={cn("h-12 rounded-xl focus:ring-rose-500 shadow-sm text-xs md:text-sm bg-white dark:bg-slate-900 transition-all font-bold", (showErrors && !formData.relationship) ? "border-2 border-red-500" : "border border-slate-200 dark:border-white/10")}>
                            ...
                            {currentStep === "SUBJECT" && (
                                ...
                                >
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-xs text-slate-500 font-medium italic">Provide the details of the marriage record that needs certified true copy request</p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="md:col-span-2 space-y-2">
                                            ...
                                            <Input
                                                ...
                                                className={cn(
                                                    ...
                                                    (showErrors && !formData.husbandFullName) ? "border-2 border-red-500" : "border border-slate-200 dark:border-white/10"
                                                )}
                                            />
                                        ...
                                        <div className="md:col-span-2 space-y-2">
                                            ...
                                            <Input
                                                ...
                                                className={cn(
                                                    "rounded-xl bg-white dark:bg-slate-900 h-12 transition-all uppercase font-medium",
                                                    (showErrors && !formData.wifeFullName) ? "border-2 border-red-500" : "border border-slate-200 dark:border-white/10"
                                                )}
                                            />
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                className={cn(
                                                    ...
                                                    (showErrors && !formData.dateOfMarriage) ? "border-2 border-red-500" : "border border-slate-200 dark:border-white/10"
                                                )}
                                            />
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                className={cn(
                                                    "rounded-xl bg-white dark:bg-slate-900 h-12 transition-all uppercase font-medium",
                                                    (showErrors && !formData.placeOfMarriage) ? "border-2 border-red-500" : "border border-slate-200 dark:border-white/10"
                                                )}
                                            />
                                ...
                                >
                                    ...
                                    <Card className="bg-slate-50 dark:bg-white/5 border-none p-6 rounded-[2rem] space-y-4">
                                        <div className="grid grid-cols-2 gap-6">
                                            ...
                                            <div className="col-span-2 border-t border-slate-200 dark:border-white/5 pt-4 space-y-1">
                                                <span className="text-[9px] font-black uppercase tracking-widest text-rose-500 italic">Certified True Copy Review</span>
                                            </div>
                                            <div className="space-y-1">
                                                <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 italic">Husband&apos;s Full Name</span>
                                                <p className="font-black text-slate-900 dark:text-white italic uppercase">{formData.husbandFullName}</p>
                                            </div>
                                            <div className="space-y-1">
                                                <span className="text-[9px] font-black uppercase tracking-widest text-slate-400 italic">Wife&apos;s Full Name (Maiden Name)</span>
                                        ...
                                        {/* Fee Display */}
                                        <div className="space-y-3 p-4 rounded-2xl bg-rose-50 dark:bg-rose-500/10 border border-rose-200/60 dark:border-rose-500/20">
                                            ...
                                            <div className="border-t border-rose-200/40 dark:border-rose-500/20 pt-2 flex items-center justify-between">
                                                <div>
                                                ...
                                                <div className="text-right">
                                                    <span className="text-lg font-black text-rose-600 dark:text-rose-400 tracking-tight">₱{apptTotalAmount.toFixed(2)}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </Card>
                                            ...
                                            className={cn(
                                                ...
                                                policyAccepted
                                                    ...
                                                    : showErrors
                                                        ...
                                                        : "border-slate-200 dark:border-white/5 hover:bg-slate-100/50 dark:hover:bg-white/5"
                                            )}
                                        >
                                            <div
                                                className={cn(
                                            ...
                                            <div className="flex-1 text-xs text-left">
                                                ...
                                                <div className="text-[10px] text-slate-500 italic mt-1 leading-relaxed">
                                                    I AUTHORIZE THE LGU TO PROCESS MY PERSONAL INFORMATION IN ACCORDANCE WITH THE DATA PRIVACY ACT OF 2012 AND TERMS OF USE.
                                                </div>
                                            ...
                                            <button
                                                ...
                                                className="text-[10px] font-black italic text-rose-600 hover:underline shrink-0"
                                    ...
                                    <div className="flex gap-4 pt-4 w-full">
                                        <Button
                                            ...
                                            className="h-14 px-8 rounded-full font-black uppercase italic tracking-widest select-none"
                                        >
                                            Back
                                        </Button>
                                        <Button
